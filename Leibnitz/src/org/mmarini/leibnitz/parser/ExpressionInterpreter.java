...
public class ExpressionInterpreter implements InterpreterContext {
	...
	private int[] index;
	private Queue<Command> stack;
	private int indexStack;
	private Map<String, Command> symbolTable;
	 ...
	 */
	@Override
	public void generateParseException(AbstractExpression expression)
	 ...
	 */
	@Override
	public void generateParseException(String name)
			throws FunctionParserException {
	 ...
	 * @throws FunctionParserException
	 */
	public Command parse(String text, AbstractExpression syntax)
			throws FunctionParserException {
		init(text);
	 ...
	 * @param definition
	 */
	public void put(String id, Command definition) {
