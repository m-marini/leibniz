...
\begin{enumerate}
\item definizione di vettori e matrici funzionali di dimensione m (n. di gradi di libertà)
...
The file definition of xml is leibnitz-0.1.0.xsd
...
La forza agente sulla particella invece è
...
Calcoliamo la velocità angolare per mantenere la particella in una traiettoria circolare parallela al piano
...
\begin{equation}
m\frac{K}{r^2}=mr\dot\varphi^2 \Rightarrow \dot\varphi=\frac{1}{r}\sqrt {\frac{K}{r}}
\end{equation}
