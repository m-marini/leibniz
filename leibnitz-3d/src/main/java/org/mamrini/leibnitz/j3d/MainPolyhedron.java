...
public class MainPolyhedron extends JApplet {
	...
	public static void main(String[] args) throws ParserConfigurationException,
		...
		MainPolyhedron main = new MainPolyhedron();
		main.createFrame();
	}
	...
	private void createSceneGraph() {
		...
		Primitive s = new Dodecahedron(1f);

		TransformGroup tg1 = new TransformGroup();
		tg1.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
		tg1.addChild(s);

		Alpha alpha1 = new Alpha(-1, 1 * K);
		RotationInterpolator rotor1 = new RotationInterpolator(alpha1, tg1);
		rotor1.setSchedulingBounds(bounds);

		TransformGroup tg2 = new TransformGroup();
		tg2.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
		tg2.addChild(tg1);
		Alpha alpha2 = new Alpha(-1, 60 * K);
		RotationInterpolator rotor2 = new RotationInterpolator(alpha2, tg2);
		...
		Alpha alpha3 = new Alpha(-1, 10 * K);

		Transform3D ta3 = new Transform3D();
		ta3.rotY(Math.PI / 2);

		RotationInterpolator rotor3 = new RotationInterpolator(alpha3, tg3);
