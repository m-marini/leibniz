 ...
 * 
 */
public class AddACommand extends AbstractBinaryCommand {
	 ...
	 * @param function2
	 */
	public AddACommand(final Command function1, final Command function2) {
	...
	public void apply(final CommandContext context) {
		...
		final Array a2 = context.getArray();
		a1.add(a2);
		context.setArray(a1);
	}
