...
public abstract class AbstractVariableCommand extends AbstractCommand implements
	 ...
	 * @return
	 */
	public static AbstractVariableCommand create(String id, Command initCmd) {
	 ...
	 * @param name
	 */
	protected AbstractVariableCommand(String name) {
		this.name = name;
	}
	 ...
	 */
	public void setInitFunction(Command initFunction) {
	 ...
	 */
	@Override
	public void setUpdateFunction(Command updateFunction) {
